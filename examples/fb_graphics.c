...
int main()
{
    ...
    do { 
        ...
        ssd1306_framebuffer_draw_text_extra(fbp, "ABCDeF", 0, 32, 32, SSD1306_FONT_DEFAULT, 4, opts, 1);
        ssd1306_framebuffer_bitdump(fbp);
        ...
        opts[1].type = SSD1306_OPT_ROTATE_FONT;
        opts[1].value.rotation_degrees = 30;
        ssd1306_framebuffer_draw_text_extra(fbp, "ABCDeF", 0, 32, 32, SSD1306_FONT_DEFAULT, 4, opts, 2);
        ssd1306_framebuffer_bitdump(fbp);
    } while (0);
    if (fbp)
